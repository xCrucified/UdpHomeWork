    ...
    public static class Seeder
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Phrase>().HasData(
                new Phrase { Id = 1, Name = "What's up brudda!" },
                new Phrase { Id = 2, Name = "It's time to shutdown the computer and go to do some exercises!" },
                new Phrase { Id = 3, Name = "I don't have a personal name because I'm just a computer program created by OpenAI. You can call me \"Assistant\" or anything you prefer. How can I assist you today?" },
                new Phrase { Id = 4, Name = "Pandas are fascinating creatures! The giant panda (Ailuropoda melanoleuca) is a bear native to China, known for its distinctive black and white coat." },
                new Phrase { Id = 5, Name = "Hello World" },
                new Phrase { Id = 6, Name = "I don't have access to real-time information as my knowledge is based on data only up to September 2021. To find out the current time, you can check a clock, watch, or use a device with internet access, such as a computer or smartphone, which typically displays the current time in the system tray or on the lock screen." }
            );
